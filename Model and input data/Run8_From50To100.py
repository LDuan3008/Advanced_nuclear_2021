...
print () 
print ()  
print (case_dic['year_start']) 
print (case_dic['year_end']) 
print (len(tech_list[demand_idx]['series']))
print (len(tech_list[solar_idx]['series']))
print (len(tech_list[wind_idx]['series']))
print (len(tech_list[solar_fixed_idx]['series']))
print (len(tech_list[wind_fixed_idx]['series']))
...
### Getting base case
case_name = 'AdvaNuclear' + '_Year' + str(year) + '_' + region + '_Co2Cons50.0'
...
for tech_idx in range(len(tech_list)):
    ...
    if tech_list[tech_idx]['tech_name'] == 'conventional_nuclaer_fixed':
        tech_list[tech_idx]['capacity'] = results_tech_dic['conventional_nuclear capacity'] 

case_dic['case_name'] = 'zzzto100_' + case_name
