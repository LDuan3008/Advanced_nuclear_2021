        ...
        if 'series_file' in tech_dic:
            ...
            if 'normalization' in tech_dic:
                if tech_dic['normalization'] >= 0.0:
                    ...
                    # if tech_dic['tech_name'] == 'solar':
                    #     series1 = series * 0.31572691895682375/np.std(series)
                    #     series = series1 + 0.2767645890773573 - np.average(series1)
                    # if tech_dic['tech_name'] == 'wind':
                    #     series1 = series * 0.20293921686023253/np.std(series)
                    #     series = series1 + 0.4345064325528539 - np.average(series1)
                    # if tech_dic['tech_name'] == 'demand':
                    #     series = series * tech_dic['normalization']/np.average(series)
