...
for dac_cost_idx in range(len(dac_vari_costs)):
    tech_list[dac_idx]['var_cost'] = dac_vari_costs[dac_cost_idx] / 0.3 # convert to $/kWh
    case_dic['case_name'] = case_name_default + '_Year' + str(year) + '_' + str(region) + '_dac' + str(dac_vari_costs[dac_cost_idx])
