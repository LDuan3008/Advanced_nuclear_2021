...
from FindRegion import GetCFsName, update_series, update_timenum, update_series_ERA5
...
tech_list[solar_idx]['series_file']  = SolarCFsName[1]; update_series_ERA5(case_dic, tech_list[solar_idx], SolarCFsName)
tech_list[wind_idx]['series_file']   = WindCFsName[1];  update_series_ERA5(case_dic, tech_list[wind_idx], WindCFsName)
